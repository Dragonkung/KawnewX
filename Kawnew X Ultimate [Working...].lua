...
local Library = Update:Window("K_Now Ultimate 𝕏","",Enum.KeyCode.RightControl);
...
Cr:Label("Credit : Kawnew X Hubb!!")
Cr:Line()
Cr:Label("DEX : ขอบคุณที่ใช้งาน")
Cr:Line()
Cr:Label("DEX : สคริป Beta ")
Cr:Line()
Cr:Button("Copy Link Discord",function()
    setclipboard("ยังไม่มา รอก่อนนะ")
end)
